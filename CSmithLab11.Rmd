...
Answer: There is a linear relationship. The mass of an egg increases linearly as the mass of the male increases.
...
ggplot(birds, aes(male_mass, egg_mass)) +
  ...
  geom_point(color = "red", data = parrots) +
   annotate("text", x = 200, y = 6, label = "Parrots", color = "red")
...
```{r}
ggplot(birds, aes(male_mass, clutch_size)) +
  geom_point(color = "purple", alpha = 0.15) +
  scale_x_log10() +
  scale_y_log10() +
  geom_point(alpha = 0.15) +
  geom_point(size = 3, color = "orange", data = penguins) +
  annotate("text", x = 12000, y = 2, label = "Penguins", color = "orange") +
  ggtitle("The clutch size of birds by male mass") +
  xlab("Male mass") +
  ylab("Clutch size")
