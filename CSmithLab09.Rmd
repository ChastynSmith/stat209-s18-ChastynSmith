...
Murders by state in 2014
```{r}
ggplot(murder, aes(state, murders_2014)) +
       geom_point()
```

Murders by city in 2014
```{r}
ggplot(murder, aes(city, murders_2014)) +
  geom_point()
```

Murders in 2014 vs murders in 2015
```{r}
...
ggplot(murder, aes(city, murders_2014)) +
  ...
  annotate("text", x = "Chicago", y = 411, label = "Chicago")
